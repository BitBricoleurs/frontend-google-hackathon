...
import { mockUsersList, mockUserErrors, filterUsers, paginateUsers } from "../data/users.fixtures";
...
export const usersHandlers = [
  ...
  http.delete(`${API_BASE_URL}/api/v1/users/:id`, ({ request, params }) => {
    ...
    return HttpResponse.json({ message: "User deactivated successfully" }, { status: 200 });
  }),
